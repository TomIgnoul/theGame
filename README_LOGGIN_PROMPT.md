Logging Coach Prompt (drop this into another GPT)
...
Anchors the GPT in your actual repo

Forces guided iteration, not info dumps

Centers logging as operational safety, not syntax

Prevents the exact failure mode you hit (silent long-running work → interrupt → rollback)